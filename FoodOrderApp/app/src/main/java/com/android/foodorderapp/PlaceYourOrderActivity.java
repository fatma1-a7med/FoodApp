...
public class PlaceYourOrderActivity extends AppCompatActivity {
    ...
    private void onPlaceOrderButtonClick(RestaurantModel restaurantModel) {
        ...
        if (inputName.getText().toString().equals("FatmaAhmed") && inputAddress.getText().toString().equals("JihanStreet") && inputCity.getText().toString().equals("ElMansoura") && inputState.getText().toString().equals("Egypt") && inputCardNumber.getText().toString().equals("1000166718") && inputCardExpiry.getText().toString().equals("2030") && inputCardPin.getText().toString().equals("222")) {
            ...
            {
                //incorrect
                Toast.makeText(PlaceYourOrderActivity.this, "LOGIN FAILED !!!", Toast.LENGTH_SHORT).show();
            }
